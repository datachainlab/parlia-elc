...
mod test {
    ...
    fn test_success_submit_misbehavior() {
        ...
        mock_consensus_state.insert(
            ...
            ConsensusState {
                current_validators_hash: misbehavior.header_2.current_epoch_validators_hash(),
                previous_validators_hash: misbehavior.header_2.previous_epoch_validators_hash(),
                ..Default::default()
            },
        );
        let ctx = MockClientReader {
